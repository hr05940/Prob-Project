...
\lstinputlisting[firstline=5,lastline=13,language=python]{codes/q1.py}
Calling the function for several iterations to get multiple expected values:
\lstinputlisting[firstline=16,lastline=33,language=python]{"codes/q1.py}
\pagebreak
...
\includegraphics[scale = 0.5]{Q1/1.1/q1_n = 18_ p = 0.5.png}\\
The above histogram appears to follow a normal distribution with a mean of $3.267$ and variance of $0.233$.\\
\includegraphics[scale = 0.5]{Q1/1.1/q1_n = 10_ p = 0.7.png}\\
The above histogram appears to follow a normal distribution with a mean of $3.267$ and variance of $0.233$.\\
\pagebreak
%--------------------------------  1.2  ------------------------------------
\subsection*{1.2}
Function implementation in Python:
\lstinputlisting[firstline=36,lastline=44,language=python]{codes/q1.py}
Calling the function for several iterations to get multiple expected values:
\lstinputlisting[firstline=46,lastline=63,language=python]{codes/q1.py}
\pagebreak
Histograms produced by the above code for various combinations of $n$ and $p$:\\
\includegraphics[scale = 0.5]{Q1/1.2/Q1.2 _n = 20_p = 0.5.png}\\
The above histogram appears to follow a normal distribution with a mean of $3.267$ and variance of $0.233$.\\
\includegraphics[scale = 0.5]{Q1/1.2/Q1.2 _n = 24_p = 0.5.png}\\
The above histogram shows that...\\
\includegraphics[scale = 0.5]{Q1/1.2/Q1.2 _n = 20_p = 0.7.png}\\
The above histogram shows that...\\
\includegraphics[scale = 0.5]{Q1/1.2/Q1.2 _n = 23_p = 0.7.png}

\pagebreak
%--------------------------------  1.3  ------------------------------------
\subsection*{1.3}
Function implementation in Python:
\lstinputlisting[firstline=65,lastline=79,language=python]{codes/q1.py}
Calling the function for several iterations to get multiple expected values:
\lstinputlisting[firstline=81,lastline=104,language=python]{codes/q1.py}
\newpage
%--------------------------------  2.*  ------------------------------------
  ...
  \subsection*{2.2}  
      In the code we see that :
        ...
        $$f_Y(y)=\frac{1}{y^2} for y \geq 1$$
         \lstinputlisting[firstline=23,lastline=25,language=python]{codes/Q2.py}
  ...
  \subsection*{2.3}    
    For, $$f_Y (y) = \frac{1}{y^3}
        for y \geq \sqrt{\frac{1}{2}}$$
         ...
         $$ y=\sqrt{\frac{1}{2(1-x)} }$$
         Code:
         \lstinputlisting[firstline=35,lastline=48,language=python]{codes/Q2.py}
      ...
      For the simulation of expected values, the same code used for the above function ran for 10000 times and each run would take the mean of y :
         \lstinputlisting[firstline=51,lastline=62,language=python]{codes/Q2.py}
...
\lstinputlisting[firstline=1,lastline=48,language=python]{codes/Q3(1).py}
...
\begin{framed}
  ...
  \end{itemize}
\end{framed}
\lstinputlisting[firstline=1,lastline=46,language=python]{codes/Q3(2).py}
\begin{figure}[h]
  \centering
...
\begin{framed}
  ...
  \end{itemize}
\end{framed}
\lstinputlisting[firstline=1,lastline=53,language=python]{codes/Q3(3).py}
...
%--------------------------------  4.1  ------------------------------------
  \subsection*{4.1}
    \begin{framed}
        ...
        \end{enumerate}
    \end{framed}
    \lstinputlisting[firstline=5,lastline=34,language=python]{codes/Q4.py}
    \begin{figure}[ht]
...
%--------------------------------  4.2  ------------------------------------
  \subsection*{4.2}
    ...
    \end{framed}
    \lstinputlisting[firstline=35,lastline=73,language=python]{codes/Q4.py}
    \begin{figure}[h]
...
%--------------------------------  4.3  ------------------------------------
  \subsection*{4.3}
    ...
    \end{framed}
    \lstinputlisting[firstline=74,lastline=119,language=python]{codes/Q4.py}
    \begin{figure}[h]
