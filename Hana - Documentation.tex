...
\lstinputlisting[firstline=41,lastline=53,language=python]{q5.py}
...
\lstinputlisting[firstline=56,lastline=72,language=python]{q5.py}
...
\lstinputlisting[firstline=75,lastline=91,language=python]{q5.py}
Histogram of expected values of the null hypothesis being rejected:
\begin{center}
