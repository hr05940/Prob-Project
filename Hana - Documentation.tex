...
% \begin{figure}
%   \centering
%   \mbox{\subfigure[No. of steps taken = 20 with probability of moving a step right = 0.5.]{\includegraphics[scale = 0.35]{Q1_histograms/1.3/Q1.3 _p1 = 0.6_p2 = 0.3_pos1 = -2_pos2 = 4.png}}\quad
%   \subfigure[No. of steps taken = 24 with probability of moving a step right = 0.5.]{\includegraphics[scale = 0.35]{Q1_histograms/1.3/Q1.3 _p1 = 0.7_p2 = 0.3_pos1 = -4_pos2 = 4.png}}}
% \end{figure}
